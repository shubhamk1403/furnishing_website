...
<body>
    ...
    <div class="img-responsive"> 
        <img style="width: 1345px;" src="images/furnishing/banner_furnishing.png">
    </div>
                ...
                <ul class="grid-lod effect-2" id=grid  style="font-size: 30px;">
                    <li class="col-md-3">
                        <section class=blog-content>
                            <a href="">
                                <figure>
                                    <label style="color: #f44256; font-size: 15px">BED SHEET</label>
                                    <img src=images/furnishing/01_1_1.png alt class="img-responsive" />
                                </figure>
                            </a>
                            <article style="font-size: 15px;">
                                Our colorful range of bedsheets are made with 100% Mercerised cotton. Needless to say, they will give you an ultra-smooth surface to sleep on.
                            </article>
                        </section>
                    </li>
                    <li class="col-md-3">
                        <section class=blog-content>
                            <a href="">
                                <figure>
                                    <label style="color: #f44256; font-size: 15px">CARPETS & MATS</label>
                                    <img src=images/furnishing/02_1_1.png alt class="img-responsive" />
                                </figure>
                            </a>
                            <article style="font-size: 15px;">
                                Kurl-on’ presents to you its range of coir, jute and latex mats and rugs. Durable & sturdy, it brings with it an earthy feel that will complement the décor at your place.
                            </article>
                        </section>
                    </li>
                </ul>
