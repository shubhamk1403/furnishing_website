        ...
        <div class="row">
            ...
            <div class="contat-from-wrapper">
                ...
                <form method="post" action="php/contactfrom.php" name="cform" id="cform">
                    <div class="row">
                        <div>
                            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12"> <input name="type" id="type" type="text" placeholder="Type"> </div>
                            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12"> <input name="name" id="name" type="text" placeholder="Name"> </div>
                        </div>
                        <div style="padding-top: 80px">
                            <div class="col-md-12 col-lg-6 col-sm-6 col-xs-12"> <input name="name" id="name" type="text" placeholder="Whats your name"> </div>
                        </div>
                    <div class="clearfix"></div> <input name="" type="submit" value="Send email">
